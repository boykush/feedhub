...
func (HealthCheckResponse_ServingStatus) EnumDescriptor() ([]byte, []int) {
	return file_feed_proto_rawDescGZIP(), []int{7, 0}
}
...
const file_feed_proto_rawDesc = "" +
	...
	"\x0fSERVICE_UNKNOWN\x10\x032\xe8\x01\n" +
	"\vFeedService\x12H\n" +
	...
	"\fListArticles\x12\x1c.feed.v1.ListArticlesRequest\x1a\x1d.feed.v1.ListArticlesResponseB\x8d\x01\n" +
	"\vcom.feed.v1B\tFeedProtoP\x01Z6github.com/boykush/foresee/services/feed/gen/go;feedv1\xa2\x02\x03FXX\xaa\x02\aFeed.V1\xca\x02\aFeed\\V1\xe2\x02\x13Feed\\V1\\GPBMetadata\xea\x02\bFeed::V1b\x06proto3"
...
func file_feed_proto_init() {
	...
	file_feed_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
