...
const file_collector_proto_rawDesc = "" +
	"\n" +
	"\x0fcollector.proto\x12\fcollector.v1\"\x12\n" +
	...
	"\x0fSERVICE_UNKNOWN\x10\x032\xb4\x01\n" +
	"\x10CollectorService\x12R\n" +
	"\vHealthCheck\x12 .collector.v1.HealthCheckRequest\x1a!.collector.v1.HealthCheckResponse\x12L\n" +
