...
func (HealthCheckResponse_ServingStatus) EnumDescriptor() ([]byte, []int) {
	return file_feed_proto_rawDescGZIP(), []int{9, 0}
}
...
const file_feed_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"feed.proto\x12\afeed.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"y\n" +
	"\x04Feed\x12\x0e\n" +
	...
	"\x0fSERVICE_UNKNOWN\x10\x032\xa6\x02\n" +
	"\vFeedService\x12H\n" +
	"\vHealthCheck\x12\x1b.feed.v1.HealthCheckRequest\x1a\x1c.feed.v1.HealthCheckResponse\x12<\n" +
	"\aAddFeed\x12\x17.feed.v1.AddFeedRequest\x1a\x18.feed.v1.AddFeedResponse\x12B\n" +
